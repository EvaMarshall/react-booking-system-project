...
const pool = mysql.createPool({
  ...
  connectionLimit: 10,
  queueLimit: 0
  //add timeouts before deployment - https://www.geeksforgeeks.org/mysql/best-practices-for-mysql-database-connection-management/
});
 ...
 * 
 * Note - For that type to be valid and usable across modules, 
 * the actual connector object must be exported, so TypeScript can resolve its shape.
 */
