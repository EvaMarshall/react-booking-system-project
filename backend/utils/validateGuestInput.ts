 ...
 *
 * Used in PUT and POST guest routes to ensure the backend adheres to
 ...
 *
 * @param input - guest input object. 
 ...
 */
  ...
  const isValidAdmin = typeof isAdmin === "boolean";

  if (!isValidName || !isValidEmail || !isValidPhone || !isValidAddress || !isValidAdmin) {
