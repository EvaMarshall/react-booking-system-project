...
import availabilityData from "../data/availabilityData"; // Import availability data
...
//new
import { fetchAvailability, AvailabilityResult } from "../apis/availability";
/*
    ...
    useEffect(() => {
        const loadAvailability = async () => {
            try {
                ...
                data.forEach((entry) => {
                    console.log("Entry availability:", entry.available_date, entry.is_available, typeof entry.is_available);
                });
